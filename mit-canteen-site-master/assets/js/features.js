    ...
    previewNavbar.innerHTML = `
        <div class="container flex text-center jc-ai-center">
            ...
            <div class="site-title flex align-item-center">
                <div>
                    <a href="index.html"><h1><span class="clr-red">SITCOE </span> <span class="clr-green">Canteen</span></h1></a>
                </div>
                <!-- Toggle Bars -->
            ...
            <!-- Upper Footer -->
                <main class="grid grid-3">
                    ...
                    <article class="about">
                        ...
                        <p>Sharad Institute of Technology is governed by Shri shamrao patil educational Trust which was founded 
                        in 2008 by a group of industrialists and educationalists
                        who shared a vision of establishing centers of scientific
                        learning around the country.</p>
                        <ul class="py-1">
                            <li><i class="fab fa-facebook-f"></i><a href="https://www.facebook.com/sharadinstitute/" target="_blank"> Facebook</a></li>
                            <li><i class="fab fa-instagram"></i><a href="https://www.instagram.com/sharad_institute_of_technology/" target="_blank">Instagram</a></li>
                        </ul>
                    </article>
                    <!-- Navigation Links -->
                    <article class="quick-links">
                        <ul>
                            ...
                            <li><a href="https://mitindore.co.in/" target="_blank">SITCOE </a></li>
                        </ul>
                    </article>
                    <!-- Contact Details -->
                    <article class="contact">
                        <ul>
                            ...
                            <li> <i class="fas fa-envelope"></i> <p>admission@SITCOE.co.in</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p> SITCOE Yadrav (MH)-416121</p></li>
                ...
                <main class="deep-devs flex">
                    ...
                    <div class="">Designed & Developed with <i class="fas fa-heart clr-red"></i> By <a href="#">Harsh Bailurkar, Sukhankar Hanaminahal, Makarand Hinge, Adarsh Belnekar</a></div>
                </main>
            </section>
        `;
        })
                ...
                <main class="grid grid-3">
                    ...
                    <article class="quick-links">
                        <ul>
                            ...
                            <li><a href="https://github.com/rvutd/mit-canteen-site" target="_blank">Git Repository</a></li>
                            <li><a href="https://mitindore.co.in/" target="_blank"> SITCOE</a></a></li>
                        </ul>
                    </article>
                    <!-- Contact Details -->
                    <article class="contact">
